...
“The man who called it in works at the elevator. Hank Dorsey. His pickup is silver, and the front of it is pushed in. He told patrol he hit a deer last week, and patrol didn’t like the way he said it.” She hands you the sheet. “Dr. Rao has the bike and the fragment. Theo’s downstairs. Report on my desk by eleven Friday morning, {det}. Bring me the chain, not a hunch.”`,
  ...
  leads: {
    ...
    castellano: { title: 'Castellano Collision', where: 'Tannery St · the Flats', kind: 'place', cost: 1.5, again: 0.5, if: 'bodyshop | brooke_repair' },
  ...
  scenes: {
    scene: {
      title: 'Harbor Road',
      text: `Harbor Road runs flat and straight here, two lanes between the lake fence and the Calder Grain elevators, which stand over everything like a row of concrete organ pipes. A grain truck goes by and the whole road shakes.

What’s left is orange spray paint on the asphalt: an outline where the bicycle lay, a circle around a dark stain. Somebody from the elevator has set a traffic cone beside it, as if she might still be there.

Officer Anita Salazar, first on scene, leans on her cruiser with a coffee she hasn’t touched. Above the Calder Grain gate, a security camera looks out over the road.`,
      ...
      choices: [
        {
          ...
          text: `“Call came in 6:18. I got here 6:24.” She looks at the cone. “She was by the fence. Her bike was in the lane, back wheel folded in half, and her taillight was still blinking, right there in the road. I switched it off. I don’t know why that’s the part I keep thinking about.

“She was eastbound, same as the car. Hit square from behind. Dorsey was kneeling next to her with his coat over her. Said the damage on his truck was a deer, last week. Wouldn’t look at me when he said it.” She nods at the gate. “Elevator has a camera. The guard wouldn’t play it without the foreman.”`,
          clues: ['struck_behind'],
        },
        {
          label: 'Walk the road',
          cost: 0.5,
          text: `You walk east from the outline with your head down. Before the impact there’s nothing: no skid, no swerve. The car never braked.

Forty feet on, that changes. Two short black marks where the tires locked, and in the gutter a glitter of clear and silver plastic too small for the techs to bother with. The car stopped here. Then the marks go on, fainter, east toward the Route 9 light and the bottom of Bluff Road.
...
Whoever it was, they stopped. They had a moment to think about it. Then they left.`,
        ...
        },
        {
          ...
          cost: 1,
          text: `There aren’t many doors: the elevator office, a boarded-up bait shop, a marine supply that opens at ten. At the marina gate the night guard is finishing a crossword in his booth.

“Six in the morning? Quiet. Always.” He thinks. “Except the Harbor Club. Some party went all night over there, big cars in the lot till dawn. Around six somebody came out of there and went east like his hair was on fire. I heard the tires.” He shrugs. “You’d be amazed what shape people drive home from that place in.”`,
          set: ['club_known'],
        },
      ],
    },
...
“Same way every morning: over the Canal Street bridge, east on Harbor Road past the elevators, up past the Route 9 light to her place on Carver. She clocked out at 5:51. I watched her go.” His jaw tightens. “She charges her lights at the station every shift. Every single shift.”`,
        ...
        },
        {
          ...
          cost: 0.5,
          text: `Lucía Ibáñez is in the family room with a vending-machine coffee, still wearing the lanyard from the school where she teaches third grade.

“We were going to see a house today. At two. On Carver, four doors down from her apartment. It has a porch.” She laughs, and the laugh breaks in the middle. “She wanted a porch so bad.”
      ...
      choices: [
        {
          ...
          text: `“Light behind me. Getting big. The engine too loud.” She stops to breathe. “I thought, he sees me. I’m lit up like a Christmas tree.”

Then the road, and the sky, and not feeling her legs. A car door. Footsteps.
...
Carmen closes her eyes. “It wasn’t a boy.”[/if]`,
        ...
        },
        {
          ...
          text: `You tell her his name, that he had been drinking all night, and that his family tried to put it on their son.
...
“His son,” she says. “God.” Then, to Russell, in her work voice: “Somebody needs to check on that kid.”`,
    ...
    lab: {
      title: 'Crime lab',
      text: `Carmen’s bicycle stands in the middle of Dr. Anjali Rao’s lab like something in a museum: a blue city bike with a wire basket and a rear wheel folded nearly in half. The rear fender is streaked with silver.

“Paint first,” Dr. Rao says. “There’s a pearl flake in the color coat, which narrows things. I’ll run the layers against the automotive database. Three hours.”

She turns the headlight fragment under her lamp. “That’s a part number. Theo can look it up faster than I can. If you find the rest of this headlight, bring it to me.”`,
      ...
      timer: {
        ...
        text: `Dr. Rao sends her results on the paint from the bicycle:

> PAINT TRANSFER · REAR FENDER AND WHEEL RIM
> Layers: e-coat, primer, color (metallic, pearl flake), clear.
> Color consistent with CELESTINE SILVER METALLIC, Lexus code 1K9.
> Offered on Lexus RX, model years 2020–2022 only.
      ...
      choices: [
        {
          ...
          cost: 0.5,
          text: `She walks you around it with a pen for a pointer. The damage is all at the back: rear wheel crushed straight forward into the frame, paint transfer at bumper height. “Struck from directly behind. No side impact at all.”

She shows you the rear light’s switch, set to flash, battery two-thirds full. “It was on.” One orange spoke reflector is missing from the rear wheel, snapped off at the clip.`,
          clues: ['struck_behind'],
        },
        {
          ...
          if: 'old_headlight',
          cost: 0.25,
          text: `She sets the cracked headlight beside the fragment. “Two hours. I want to photograph the edges under magnification before I let them touch.”`,
          timer: {
            in: 2,
            title: 'Dr. Rao: the headlight',
            text: `Dr. Rao calls instead of emailing, which she almost never does.

“The fragment from Harbor Road fits the broken corner of the Lexus headlight. Every ridge of the fracture lines up, and the part number completes: 81145-4E922. That piece of plastic came off that headlight, {name}.” A pause. “And there’s blue paint on the lens. Same paint as Ms. Ibáñez’s bicycle frame.”`,
        ...
        },
        {
          ...
          if: 'hank_grille',
          cost: 0.25,
          text: `She holds the envelope up to the light. “Two hours. I’ll take a scraping of his paint too, to put next to the transfer.”`,
          timer: {
            in: 2,
            title: 'Dr. Rao: Hank Dorsey’s truck',
            text: `Dr. Rao reports on the samples from Hank Dorsey’s pickup:

> HAIR: white-tailed deer. BLOOD: deer.
> PAINT: single-stage Ford silver, no pearl flake.
> Not consistent with the transfer on the bicycle.
...
“Harbor Road. The nurse. I heard.” Then the cheer comes back, because it always does. “Cars are my favorite. Cars leave paperwork everywhere. What have you got?”`,
...
“Toyota and Lexus number parts by system. 81145 is a left headlight housing. A 4E9 suffix is Lexus, the—” scroll, scroll “—RX, model years 2020 through 2022.” He hands you a sticky note. “Somebody’s missing a corner of their headlight.”`,
          clues: ['part_rx'],
        },
        {
          ...
          cost: 0.25,
          text: `“Silver, 2020 to 2022, registered in Calder County. Give me an hour and a half.”`,
          timer: {
            in: 1.5,
            title: 'Theo: silver RXs',
            text: `Theo emails a spreadsheet and a note:

> 26 LEXUS RX, 2020–2022, SILVER, REGISTERED IN CALDER COUNTY
> 4 in Bluffside, all off Bluff Road, at the east end of Harbor Road.
...
“One of the four is a 2021 registered to **Dale and Brooke Whitcomb**, 40 Bluff Crest Drive, plate CKW 4471. As in *Councilman* Whitcomb. I’m not saying anything. I’m just saying it.”`,
        ...
        },
        {
          ...
          if: 'part_rx | paint_lexus',
          cost: 0.25,
          text: `“A nice SUV with a smashed headlight goes to a body shop the same day, every time.” He cracks his knuckles. “Thirty-one shops in the county. Two hours.”`,
          timer: {
            in: 2,
            title: 'Theo: body shops',
            text: `Theo calls back, a little hoarse.

“Thirty-one shops. One guy in Lakeview tried to sell me an extended warranty. And Castellano Collision, on Tannery Street in the Flats, has a silver 2021 RX in the bay for a left headlight, a bumper cover and paint. Booked this morning, rush. The kid who answered says the name on the ticket is Whitcomb.”`,
            clues: ['bodyshop'],
          },
        },
        {
          ...
          if: 'dale_story',
          cost: 0.25,
          text: `“Cabs log every trip with the city. Rideshare takes a call to a very bored lawyer. An hour and a half.”`,
          timer: {
            in: 1.5,
            title: 'Theo: cabs and rideshares',
            text: `Theo sends the trip records for Wednesday night:

> PICKUPS AT THE HARBOR CLUB · WED 22:00 – THU 03:00
...
“Unless the councilman walked three miles uphill in dress shoes,” he writes, “nobody drove him home at one.”`,
            clues: ['no_cab'],
          },
        },
        {
          ...
          cost: 0.25,
          text: `“Henry Dorsey, fifty-eight. Owns a 2012 Ford pickup, silver. And—” he winces “—a DUI in 2014, on Route 9. Lost his license for a year, did the classes, got it back. Nothing since. Not a parking ticket.”
...
He looks at you over his glasses. “That’s not great, huh. For him.”`,
    ...
    hank: {
      title: 'Calder Grain',
      text: `The Calder Grain office is a trailer at the foot of the elevators. The foreman, Earl Boyce, sighs at your badge and goes to get him.

Hank Dorsey is a big, slow man in a feed cap and a canvas coat with a dark stain down the front that you realize, after a moment, is hers. Out the window his silver Ford sits with its hood held down by an orange ratchet strap.

“I told the officer already,” he says. “I found her. That’s all I did.”`,
      ...
      choices: [
        {
          ...
          text: `“I was late. Came in off Route 9, and there’s a bike in the lane and something by the fence I thought was trash.” He looks down at the stain. “I called 911. I put my coat on her. She kept trying to say something, and I kept saying don’t talk, they’re coming. I held her hand till the ambulance.”`,
        },
        {
...
You bag some of the hair. Hank watches from the trailer door and doesn’t try to stop you.`,
        ...
        },
        {
          ...
          cost: 0.75,
          text: `Past the gate, the camera catches a slice of Harbor Road, gray and grainy in the dark.

At 6:09:48 a blinking red light slides east along the far lane. At 6:10:03 headlights swell behind it, and the red light is gone. An SUV brakes hard and stops at the edge of the frame, one headlight dark. A man gets out, walks back into the glow and stands looking down for about thirty seconds. As he walks back, his head and shoulders show above the SUV’s roof. At 6:10:51 it pulls away east.
      ...
      choices: [
        {
          ...
          text: `“First stop’s the Harbor Club kitchen. I’m backing up to the door, scanner says 6:03, and this big silver SUV comes out of the valet circle like it’s shot out of a cannon. Up over the curb, across both lanes, almost takes my mirror off, then straightens out and goes east.” She shows you with the roll. “A Lexus. My brother-in-law has one, with the grille like a big mouth. One person in it. Big shape.
...
“And the valet kid runs out into the road after it, waving his arms. Like you could stop that with your arms.”`,
        ...
        },
        {
          ...
          if: 'roz_saw',
          text: `“Luis. Nice boy. When I’m late he carries the trays in for me.” Her face changes. “He was white as a sheet, standing there in the road, saying, ‘He shouldn’t be driving, he shouldn’t be driving.’ Then his boss yelled from the door and he went back in.”`,
        },
      ],
    },
    ...
    club: {
      ...
      text: `The Harbor Club sits at the marina end of Harbor Road: white clapboard, a wide porch, a flagpole flying a pennant nobody outside the club could name. The valet stand by the steps is empty, its podium locked.
...
Down the hall, behind a door marked COMMODORE ROOM, someone is running a vacuum. From the bar comes the clink of bottles being counted.`,
      again: `Graham Sutter sees you in the foyer, and his smile gets a little thinner.`,
      choices: [
        {
          label: 'Ask Sutter about Wednesday night',
          text: `“The Councilman’s reelection fundraiser. Seven until eleven, in the ballroom. Very successful.” He folds his hands. “Afterward a few members stayed on in the Commodore Room, as members do. I went home at eleven. I couldn’t tell you who stayed, or how late.”
...
“I’m sure he would,” Sutter says, and smiles.`,
        },
        {
          ...
          text: `“Our members’ comings and goings are private, Detective. If the District Attorney sends a subpoena, we will of course cooperate fully.”
...
He opens the front door for you. When you don’t go through it, he closes it again, and his expression doesn’t change at all.`,
        ...
        },
        {
          ...
          cost: 0.25,
          text: `Paneling, leather chairs, a ship model in a glass case. It hasn’t aired out: cigars, scotch, the sweet rot of spilled mixer.
      ...
      choices: [
        {
          ...
          text: `“A dozen at eleven. Four by three. By five it was just him. The Councilman. His tab, his member number.” She turns her screen, and you photograph it.

> COMMODORE RM · TAB 88 · MBR 0212 WHITCOMB, D.
> OPENED WED 23:14 · MACALLAN 18 (BTL) × 2, (BTL, PARTIAL) × 1 …
> LAST ITEM THU 05:40 · TOTAL $1,160.00

“At 5:40 I stopped pouring. He tried to tip me with his credit card and called me Sharon.” She shakes her head. “He had to hold on to the bar to get his coat on.”`,
          clues: ['shay_tab'],
        },
        {
          label: 'Ask about the valet',
          text: `“Luis Fuentes. He was on the stand all night. I told him, whatever you do, don’t bring the Councilman his car. But Luis is twenty-two, and it’s the *Councilman*.”

She writes an address on a bar napkin. “He lives with his grandmother on Ferris Street. Graham told him to keep his mouth shut, so he won’t come to you. You’ll have to go to him.”`,
          set: ['luis_known'],
        },
    ...
    luis: {
      title: 'Luis Fuentes',
      text: `Luis Fuentes’s grandmother lets you into a kitchen with a saint’s candle by the stove. “He hasn’t slept,” she says, in a way that means you are not to make it worse.

Luis is twenty-two and still in his red Harbor Club polo. He stands when you come in, then sits back down.

“Is she okay?” he says. “The lady on the radio. Is she okay?”`,
      again: `Luis’s grandmother sets a coffee in front of you without asking. Luis looks up. “Is she okay?”`,
      choices: [
        {
          label: 'Ask about the councilman’s car',
          text: `“He came out about 5:55, holding the railing. ‘Son, bring the car around.’ I said sir, let me call you a cab, it’s on me. He laughs, says, ‘I know where my keys are,’ and reaches over the podium for the key board. So I brought it. 5:58.

“He gave me a fifty. He sat in the car with the engine running a few minutes, and I thought, good, maybe he’ll fall asleep. Then he goes over the curb and across the whole road.” His voice cracks. “I ran after him. And when I told Mr. Sutter, he said the Councilman was never here after midnight, if I wanted to keep my job.”`,
          clues: ['luis_drunk'],
        },
        {
...
He sends it to you. “Is that going to get me fired?”`,
        ...
        },
        {
          ...
          if: 'luis_drunk',
          text: `He glances at his grandmother, who is pretending not to listen.

“He’s the Councilman, and Mr. Sutter signs my check. And I thought, it’s six in the morning, he’s just going up the hill, nobody’s out.” He puts his face in his hands. “Somebody was out.”`,
        },
      ],
    },
...
“It was a *deer*,” she says. And then, when nobody answers: “That’s what I thought.”`,
        ...
        },
        {
          ...
          cost: 0.25,
          text: `The empty bay smells of floor cleaner. In the trash can by the door there’s a dustpan’s worth of sweepings: grit, a leaf, and chips of clear and silver plastic, like the ones in the gutter on Harbor Road.
...
Tyler is already crying the way little kids cry, with his whole face. “I was at Maddie’s. I was asleep. Mom came and got me. Mom, I *can’t* —”
...
“I run at a quarter to six. At twenty to, I went down to the basement for my shoes, and he was on the couch. Asleep, mouth open, one sock on.” A small, fond, exasperated shrug. “Still asleep when I got back.”`,
        ...
        },
        {
          ...
          cost: 0.5,
          text: `She brings up the app on her laptop. Every time the front door moves, the camera keeps a clip.
...
You watch each clip. At 7:41 Tyler gets into the white Volvo, and you can see his mother at the wheel.

“The back door is deadbolted, and it shrieks when you open it,” Grace says. “Nobody used it.” She emails you the clips.`,
          clues: ['doorbell'],
        },
    ...
    maddie: {
      title: 'Maddie Cho',
      text: `Maddie Cho sits on the bottom stair with her phone in both hands. She’s seventeen and a couple of inches taller than Tyler, with her mother’s steady eyes, red and swollen now.

“I’m not supposed to talk to you,” she says. “He said not to.”

Grace sits down beside her and says nothing, which seems to be exactly right.`,
      again: `Maddie looks up from her phone. “What else?”`,
      choices: [
        {
          label: 'Ask her about Wednesday night',
          text: `“He was here.” Fast and fierce. “He came over because things at his house are bad, they’re always bad, and he fell asleep in the basement watching a movie. He didn’t go anywhere. He didn’t *do* anything.”
...
“He called at noon, crying. He said his dad hit somebody with the car. A lady.” She wipes her face with her wrist. “He said the lawyer said if it’s Tyler, it’s juvie. Seventeen, no record, not drinking, so it’s probation. But if it’s his dad, his dad goes to prison. So they want him to say it was him, and he’s going to, because he always does what his dad wants.”
...
She holds out her phone. A text from Tyler, 12:14 p.m.: *if anyone asks i was home last night ok. please. ill explain*`,
    ...
    castellano: {
      ...
      text: `Castellano Collision is an old brick garage on Tannery Street, with a radio playing oldies to nobody. In the second bay a silver Lexus RX sits on a lift with its face torn off: no bumper cover, a raw hole where the left headlight was, wires hanging like roots.

Ray Castellano stands in front of it with his arms folded and an unlit cigarette in his mouth: sixty-something, forearms like hams, gray crew cut. He looks at your badge, then back at the car.

“Yeah,” he says. “I figured.”`,
      again: `Ray is still standing in front of the Lexus. “Haven’t touched it. Not going to.”`,
      choices: [
        {
          label: 'Ask Ray about the job',
          text: `“Mrs. Whitcomb calls at quarter after ten. Headlight, bumper cover, paint, rush, cash. Thirty-four hundred, and she didn’t blink. Says her son hit a deer. Asks can I pick it up at the house, she doesn’t want to drive it. So I go up at eleven-thirty, and she’s got an envelope waiting.

“Then I’m driving it down Bluff Road and the radio says a nurse on a bike, on Harbor Road.” He takes the cigarette out and looks at it. “I’ve been standing here looking at this thing ever since.”`,
          clues: ['ray_job'],
        },
        {
          label: 'Ask whether a deer could have done it',
          text: `Ray snorts. “A deer leaves hair in everything. Grille, hood seams, fog lights. You’re picking it out for a week. This? Not one hair.

“What there is, is a blue scuff on the bumper cover, and this.” He drops something in your palm: a small orange reflector, the kind that clips onto the spokes of a bicycle wheel. “That was jammed in the fog light grille.”`,
          clues: ['no_deer'],
        },
        {
          label: 'Ask how the car was when he picked it up',
          text: `“Funny you ask. I get in, in their garage, and my feet don’t reach the pedals. Seat’s racked all the way back, mirrors pointed at the ceiling. I’m five-nine, and I had to move everything to back it out.

“Somebody big drove that car last. Not her, she’s a little thing. And not the kid I saw in the kitchen door, either. Skinny kid. Looked about fourteen.”`,
          clues: ['ray_seat'],
        },
        {
          label: 'Ask what he did with the old headlight',
          text: `“Scrap bin. I keep the old ones for the core charge. Habit.” He fishes it out of a steel drum by the back door: a Lexus headlight, lens starred, housing cracked, one corner broken clean off.

He hands it over. “Take it. I don’t want it in my shop.”`,
          clues: ['old_headlight'],
        },
        {
          label: 'Look over the Lexus',
          cost: 0.5,
          text: `Inside, the car smells like a bar at closing time: stale scotch, cigar smoke, expensive aftershave. There’s a Harbor Club matchbook on the passenger seat. In the cupholder, where Ray tossed it when he got in, is a laminated valet hang tag: **HARBOR CLUB VALET · 0417**.`,
          clues: ['hang_tag'],
        },
      ],
    },
    ...
    warrant: {
      ...
      text: `Assistant District Attorney Gus Pellegrino picks up with his mouth full. “Desk lunch. What have you got?”

You tell him it’s the Harbor Road hit-and-run, and that it touches Councilman Dale Whitcomb.

He stops chewing. “Terrific. Tell me exactly what you want, and exactly why a judge gives it to you.”`,
      ...
      choices: [
        {
          ...
          text: `You give it to him in order: [if headlight_match]the fragment that fits the scrap-bin headlight edge for edge[else]the part number and paint from the scene[/if], and a silver RX with its left headlight smashed going into a body shop, rush and cash, five hours after the crash.

“That’s a car I want too,” Gus says. “I’ll walk it over to Judge Rosenthal myself. Have a flatbed ready.”`,
          go: 'search',
        },
        {
          id: 'car-no',
          ...
          text: `He listens to the end. “So a councilman’s wife got her car fixed. What puts *that car* on Harbor Road? Bring me paint or a part off the scene that says RX, and I’ll get you the car.”`,
        },
        {
          label: 'Ask for a subpoena for the Harbor Club’s records',
          if: 'club_refused',
          text: `“Valet records and bar tabs for one night, with the victim in the ICU? That’s not even a hard one. I’ll have it served on Mr. Sutter this afternoon.”`,
          set: ['subpoena_sent'],
          timer: {
            in: 2,
            title: 'The Harbor Club’s records',
            text: `The Harbor Club’s records arrive by courier, with a cover letter from its lawyers that is longer than the records.
...
> OPENED WED 23:14 · LAST ITEM THU 05:40 · $1,160.00`,
    ...
    search: {
      title: 'The Lexus',
      text: `The warrant comes through a little after the hour. Ray Castellano lowers the lift himself and watches his rush job get chained onto a police flatbed.

At the police garage, Dr. Rao’s technician bags the valet hang tag from the cupholder, then plugs a laptop into a port under the dash. “These things remember everything,” she says. “Where, when, how fast. People have no idea.”`,
      clues: ['hang_tag'],
      choices: [
        {
...
Nothing else between. The car never went home at one in the morning, and it never left the garage at a quarter to six.`,
          clues: ['nav_log'],
          go: 'board',
        },
      ],
  ...
  events: [
    {
      at: 1,
      title: 'The tip line',
      text: `The desk sergeant forwards a message from the tip line. Roz Petrakis, who drives the early route for Sorrento Bakery, was on Harbor Road just after six this morning and saw “a big silver SUV driving like a lunatic.” She’s at the bakery on Canal Street until three.`,
      set: ['roz_tip'],
    },
    {
      at: 5.5,
...
“Lieutenant, this is Preston Voigt. I represent the Whitcomb family. Tyler Whitcomb, who is seventeen, was driving his father’s Lexus on Harbor Road early this morning and was involved in the accident there. He is a frightened boy with no record of any kind, and I want to be very clear that there was no alcohol involved. He will come in with me tomorrow at nine to make a full statement.”`,
    ...
    },
    {
      ...
      if: '!family_break',
      title: 'Channel 6',
      text: `Someone has leaked the name. The five o’clock news runs footage of the Whitcombs’ front gate and a statement from the councilman’s office: “Our son Tyler has made a terrible mistake, and he is ready to take responsibility for it. Our hearts are with Ms. Ibáñez and her family.”

Dale Whitcomb doesn’t appear. The station uses a file photo of him cutting a ribbon, a head taller than everyone around him.`,
      set: ['news_tyler'],
    },
    {
      at: 11.25,
...
“They lightened her sedation at six. She’s awake. She knows her name, and she asked who was covering her patients.” He laughs, wetly. “You can have five minutes if you come now. She wants to talk to you.”`,
    ...
    },
    {
      ...
      text: `At nine, in Interview Room 2 on Garland Street, with Preston Voigt beside him, Tyler Whitcomb signs a statement:

> At approximately 5:45 a.m. I took my father’s Lexus from our garage
> to drive to my girlfriend Maddie Cho’s house. On Harbor Road I hit
> something. I stopped and got out and saw that it was a person on a
> bicycle. I panicked and drove home. Nobody else was involved.
...
[if tyler_story]Yesterday Tyler told you he never stopped. Overnight, somebody has told him that the driver did.[else]It’s short and tidy, and it reads as if a lawyer wrote it.[/if]`,
    ...
    },
    {
      ...
      title: 'A call from Preston Voigt',
      text: `At nine, Preston Voigt calls Lieutenant Okafor to say that Tyler Whitcomb will not be making a statement after all, and that Councilman Whitcomb has retained separate counsel. Okafor passes it on without comment, which is its own comment.`,
    },
  ],
...
Carmen Ibáñez went back to Mercy General the next fall, on days, with a cane she hates. She drives to work now. Her sister says she bought the house with the porch.`,
    ...
    brooke: `You named Brooke Whitcomb. She paid for the repair, but she was home in bed at six that morning, and the charge was dropped within a week. Tyler signed his statement as planned, and the case closed around a seventeen-year-old who was never on Harbor Road.`,
    hank: `You named Hank Dorsey. Within days the lab matched the hair in his grille to a deer, animal control produced his 5:35 call, and the elevator’s camera showed him arriving six minutes after the crash to kneel beside her. The charge was dropped. Calder Grain let him go anyway, the week his name was in the paper. Tyler Whitcomb’s statement stood.`,
    guest: `You named a guest from the Harbor Club you couldn’t name. The valet book shows one car leaving at 5:58, with one man in it. Lieutenant Okafor sent the report back, and by then Tyler Whitcomb’s signed statement was the only account on file.`,
  ...
  solution: {
    text: `Dale Whitcomb spent Wednesday evening at his own fundraiser at the Harbor Club and the rest of the night in the Commodore Room, drinking scotch on his own tab until Shay Brennan stopped pouring at 5:40. At 5:58, over the valet’s offer of a cab, Luis Fuentes brought him his silver Lexus RX. He pulled out at 6:03, across both lanes in front of Roz Petrakis’s bakery van, and drove east on Harbor Road toward home.

At 6:10, by the Calder Grain gate, he drove into the back of Carmen Ibáñez’s bicycle as she rode home from her shift, her rear light flashing. He stopped, got out, walked back and stood over her. Then he drove on up Bluff Road with his left headlight out, past Hank Dorsey at the Route 9 light, and was home at 6:21.
